// URL base para las imágenes de directores en tu repo
const REPO_URL =
  'https://raw.githubusercontent.com/enriquebarroso/cinecuba-landing/main/src/assets/directors';

// Definimos las URLs directamente en lugar de importar archivos locales
const humbertoSolasPhoto = `${REPO_URL}/humberto-solas.jpg`;
const tomasGutierrezAleaPhoto = `${REPO_URL}/tomas-gutierrez-alea.jpg`;
const juanCarlosTabioPhoto = `${REPO_URL}/juan-carlos-tabio.jpg`;
const fernandoPerezPhoto = `${REPO_URL}/fernando-perez.jpg`;
const ernestoDaranasPhoto = `${REPO_URL}/ernesto-daranas.jpg`;
const miguelCoyulaPhoto = `${REPO_URL}/miguel-coyula.jpg`;
const octavioCortazarPhoto = `${REPO_URL}/octavio-cortazar.jpg`;
const rolandoDiazPhoto = `${REPO_URL}/rolando-diaz.jpg`;
