...
export const actors: Actor[] = [
  ...
  },
  {
    ...
    deathYear: 2022,
    nationality: 'Cubano',
    photo: '/images/actors/alexis-diaz-de-villegas.jpg',
    biography: "Alexis Díaz de Villegas (7 de diciembre de 1966 — 24 de junio de 2022) fue uno de los actores más completos y queridos del teatro y el cine cubano de las últimas tres décadas. Actor y profesor de Artes Escénicas del Instituto Superior de Arte, desde 1987 trabajó con las figuras fundamentales de la escena cubana — Víctor Varela, Carlos Díaz, Carlos Celdrán — acumulando premios del Festival Nacional de Teatro en 2000, 2002, 2004 y 2006. En 1998 comenzó su vínculo con el grupo Argos Teatro de Carlos Celdrán, con quien creó algunos de los espectáculos teatrales más celebrados de La Habana. En el cine tuvo una trayectoria notable con títulos como El cuerno de la abundancia, Habana Blues y Kangamba, pero su consagración llegó con Juan de los muertos (2011) de Alejandro Brugués — la primera película de zombis cubana, ganadora del Premio Goya a la Mejor Película Extranjera de Habla Hispana en 2013. Lo que pocos sabían entonces es que mientras filmaba esa película en 2011, le diagnosticaron un Linfoma No Hodgkin. Durante once años convivió con la enfermedad sin dejar de trabajar, hasta filmar Insular, su último trabajo, estrenado en el Festival Internacional de Cine de la India. Falleció el 24 de junio de 2022 a los 56 años, dejando a su hija Alexandra de 8 años. Carlos Celdrán le dedicó estas palabras: 'Tu talento, tu energía estuvieron tan cerca de mí que por un momento pensé que eras todo el teatro.'",
    awards: [
      'Premio de Actuación Masculina — Festival Nacional de Teatro (2000, 2002, 2004, 2006)',
      'Premio Caricato — UNEAC (2004 y 2006)',
      'Premio Terry de Actuación Masculina — UNEAC',
      'Premio Exaequo — UNEAC',
      'Premio al Mejor Actor — Festival de Fantasporto, por Juan de los muertos',
      'Premio Goya a la Mejor Película Extranjera de Habla Hispana — por Juan de los muertos (2013, compartido con el equipo)',
      'Premio Póstumo al Mejor Actor — Festival de Cine Fine Arts Hecho en RD, por Insular (2023)',
      'Distinción por la Cultura Nacional — Cuba',
    ],
  },
  {
  ...
  },
  {
    ...
    photo: '/images/actors/benicio-del-toro.jpg',
    biography: "Benicio Monserrate Rafael del Toro Sánchez nació el 19 de febrero de 1967 en San Germán, Puerto Rico. Hijo de abogados, a los 9 años perdió a su madre y la familia se trasladó a Pensilvania. Comenzó estudios de Comercio en California pero los abandonó para estudiar actuación con Stella Adler en Los Ángeles y en Nueva York. Debutó en el cine con Big Top Pee-wee (1988) y se convirtió en el actor más joven en interpretar a un villano de James Bond en Licencia para matar (1989). Su gran oportunidad llegó con Sospechosos habituales (1995) y su consagración internacional con Traffic (2000), por la que ganó el Oscar, el Globo de Oro, el BAFTA y el SAG al Mejor Actor de Reparto. En el catálogo de CineCuba aparece en el papel más emblemático de su carrera: Ernesto Che Guevara en el díptico Che (2008) de Steven Soderbergh, película que él mismo produjo y para cuyas escenas finales perdió más de quince kilos. Por esa interpretación ganó el Premio al Mejor Actor en el Festival de Cannes y el Premio Goya, y Sean Penn declaró públicamente su indignación porque del Toro no fue nominado al Oscar. Ha trabajado con los directores más importantes del mundo — Soderbergh, Iñárritu, Villeneuve, Paul Thomas Anderson — y tiene nacionalidad española desde 2008.",
    awards: [
      'Oscar al Mejor Actor de Reparto — por Traffic (2001)',
      'Globo de Oro al Mejor Actor de Reparto — por Traffic (2001)',
      'BAFTA al Mejor Actor de Reparto — por Traffic (2001)',
      'SAG Award al Mejor Actor de Reparto — por Traffic (2001)',
      'Nominación Oscar al Mejor Actor de Reparto — por 21 gramos (2004)',
      'Premio al Mejor Actor — Festival Internacional de Cine de Cannes, por Che (2008)',
      'Premio Goya al Mejor Actor — por Che (2008)',
      'Nominación BAFTA al Mejor Actor de Reparto — por Sicario (2016)',
      'Nominación Emmy al Mejor Actor de Miniserie — por Escape at Dannemora (2019)',
    ],
  },
  {
    id: 'caleb-casas',
  ...
  },
  {
    ...
    name: 'Javier Bardem',
    birthYear: 1969,
    birthPlace: 'Las Palmas de Gran Canaria, España',
    nationality: 'Español',
    photo: '/images/actors/javier-bardem.jpg',
    biography: "Javier Ángel Encinas Bardem nació el 1 de marzo de 1969 en Las Palmas de Gran Canaria. Proviene de una familia con profundas raíces en el mundo del espectáculo — su madre es la actriz Pilar Bardem y su padre tenía raíces cubanas. Considerado el actor español más internacional de la historia, su conexión con Cuba es doble: su vínculo familiar con la isla y su papel definitorio como el poeta cubano Reinaldo Arenas en Antes que anochezca (2000) de Julian Schnabel, interpretación por la que recibió su primera nominación al Oscar y la Copa Volpi en el Festival de Venecia. En el catálogo de CineCuba aparece en esa misma película, rodada en parte en Cuba y considerada una de las más importantes sobre la disidencia cubana. Su carrera es una de las más brillantes del cine internacional: ganador del Oscar al Mejor Actor de Reparto por No es país para viejos (2007) de los hermanos Coen, Premio al Mejor Actor en Cannes por Biutiful (2010) y dos veces ganador de la Copa Volpi en Venecia. Ha trabajado con los directores más importantes del mundo — Coen, Amenábar, Almodóvar, Villeneuve, Iñárritu — y está casado con Penélope Cruz desde 2010.",
    awards: [
      'Copa Volpi al Mejor Actor — Festival de Venecia, por Antes que anochezca (2000)',
      'Nominación Oscar al Mejor Actor — por Antes que anochezca (2001)',
      'Premio Goya al Mejor Actor — por Los lunes al sol (2003)',
      'Copa Volpi al Mejor Actor — Festival de Venecia, por Mar adentro (2004)',
      'Premio Goya al Mejor Actor — por Mar adentro (2005)',
      'Premio del Festival de Cannes al Mejor Actor — por Biutiful (2010)',
      'Oscar al Mejor Actor de Reparto — por No es país para viejos (2008)',
      'Globo de Oro al Mejor Actor de Reparto — por No es país para viejos (2008)',
      'BAFTA al Mejor Actor de Reparto — por No es país para viejos (2008)',
      'Premio SAG al Mejor Actor de Reparto — por No es país para viejos (2008)',
      'Nominación Oscar al Mejor Actor — por Biutiful (2011)',
      'Nominación Oscar al Mejor Actor — por Ser los Ricardo (2022)',
      'Premio Goya al Mejor Actor — por El buen patrón (2022)',
  ...
  },
  {
    ...
    birthPlace: 'La Habana, Cuba',
    nationality: 'Cubano',
    photo: '/images/actors/patricio-wood.jpg',
    biography: "Patricio Wood Pujols nació el 31 de enero de 1961 en La Habana, hijo de los primeros actores Salvador Wood y Yolanda Pujols, y padre del también actor Gabriel Wood — tres generaciones de una misma familia dedicadas al arte cubano. Desde pequeño participó en televisión con Los comandos del silencio (1968) y en teatro infantil, pero su consagración llegó muy joven con su papel protagónico en El brigadista (1977) de Octavio Cortázar, película que obtuvo el Oso de Plata en el Festival de Berlín. Lo que hace ese debut especialmente emotivo es que compartió escena con su propio padre Salvador Wood, la única vez que padre e hijo actuaron juntos en el cine. Ingresó en el Instituto Superior de Arte en 1978 y se graduó en Actuación en 1984. A lo largo de su carrera ha actuado en más de diez largometrajes cubanos e internacionales, en más de quince series y telenovelas de televisión, y ha interpretado por primera vez en la televisión cubana a figuras históricas como Camilo Cienfuegos, Carlos Finlay y Antonio José de Sucre. Ha trabajado con directores como Tomás Gutiérrez Alea, Juan Carlos Tabío y Fernando Pérez, con quien protagonizó Últimos días en La Habana (2016), que ganó el Premio al Mejor Film Iberoamericano en el Festival de Málaga. Es también realizador de documentales — su último trabajo, Esa es la vida Octavio (2022), sobre el director Octavio Cortázar, fue premiado por la Unión de Periodistas de Cuba.",
    awards: [
      'Oso de Plata — Festival Internacional de Cine de Berlín, por El brigadista (1978, compartido con el equipo)',
      'Diploma Fundador de la FENOC — ICAIC (1980)',
      'Mención Actuación de Cine — UNEAC (1981)',
      'Medalla por la Cultura Nacional — MINCULT (1986)',
      'Premio Actuación — Festival de la Radio, ICRT (1987)',
      'Premio Caracol por Realización de Cortometrajes — UNEAC y AHS (1988)',
      'Medalla por Servicio Distinguido — MININT (1988)',
      'Distinción Majadaonda — UNEAC (1990)',
      'Premio Actuación Caricato — UNEAC (2003)',
      'Premio de la Popularidad — ICRT, Programa Entre tú y yo (2004)',
    ],
  },
  {
  ...
  },
  {
    ...
    deathYear: 2004,
    nationality: 'Cubana',
    photo: '/images/actors/raquel-revuelta.jpg',
    biography: "Raquel Revuelta Planas (14 de noviembre de 1925 — 24 de enero de 2004) fue una de las figuras más influyentes de la cultura cubana del siglo XX: actriz, directora teatral, pedagoga y fundadora de instituciones fundamentales para las artes escénicas de la isla. Provenía de una familia de artistas — era hija de la actriz Silvia Planas y hermana del legendario director teatral Vicente Revuelta. Comenzó su carrera artística en 1936 en el programa de radio La Corte Suprema del Arte. En 1941 fue una de las fundadoras del Teatro Popular y en 1958 cofundó el Grupo Teatro Estudio junto a su hermano Vicente, Sergio Corrieri y otros artistas, agrupación que dirigió durante más de 36 años y que se convirtió en el referente de la vanguardia teatral cubana. En el cine trabajó en producciones memorables dirigida por Humberto Solás — quien la definió como 'un acto de suplicio y veneración al mismo tiempo' — y por otros grandes directores del cine cubano. Fue también Profesora Titular y Decana de la Facultad de Artes Escénicas del Instituto Superior de Arte, y en 1985 recibió el título de Doctora Honoris Causa. Falleció en La Habana el 24 de enero de 2004.",
    awards: [
      'Trofeo Antillana — Redactores Cinematográficos y Teatrales (1954)',
      'Gran Premio Avellaneda — Actriz Más Valiosa del Año (1954)',
      'Premio ARTYC a la Mejor Actriz del Año (1956)',
      'Coral de Honor — Festival Internacional del Nuevo Cine Latinoamericano',
      'Doctora Honoris Causa en Artes — Instituto Superior de Arte (1985)',
      'Premio Nacional de Teatro — Cuba (1999)',
      'Orden Félix Varela — Cuba',
      'Medalla Alejo Carpentier — Cuba',
      'Distinción por la Cultura Nacional — Cuba',
    ],
  },
  {
  ...
  },
  {
    ...
    name: 'Rosita Fornés',
    birthYear: 1923,
    birthPlace: 'Nueva York, Estados Unidos (padres cubanos)',
    deathYear: 2020,
    nationality: 'Cubana',
    photo: '/images/actors/rosita-fornes.jpg',
    biography: "Rosalía Lourdes Elisa Palet Bonavia (11 de febrero de 1923 — 10 de junio de 2020), conocida como Rosita Fornés, fue la vedette más grande que ha dado Cuba y una de las figuras más emblemáticas de la cultura cubana del siglo XX. Nació en Nueva York de padres españoles radicados en Cuba y creció en La Habana. A los 15 años debutó en el concurso de radio La Corte Suprema del Arte de la CMQ, ganando el primer premio de interpretación musical. Su carrera abarcó más de ocho décadas y se extendió por Cuba, México, España y toda América Latina, brillando en el teatro, la radio, la televisión y el cine. En México desarrolló una exitosa carrera cinematográfica en los años 40 y 50. Su debut en el cine cubano revolucionario llegó en Se permuta (1983) de Juan Carlos Tabío, donde declaró que fue su primera satisfacción plena en el cine. Papeles secundarios (1989) de Orlando Rojas le permitió mostrar facetas dramáticas que muchos desconocían. Fue fundadora de la televisión cubana y, según muchos, el paradigma de artista cubana que vivió de manera natural la internacionalidad sin perder su cubanía. Falleció el 10 de junio de 2020 en Miami a los 97 años.",
    awards: [
      'Premio Girasol de popularidad — Revista Opina (década de 1980)',
      'Premio de Actuación Femenina — Festival de Teatro de La Habana (1988)',
      'Premio del Gran Teatro de La Habana (1988)',
      'Premio Nacional de Teatro — Cuba (2001)',
      'Premio Nacional de Televisión — Cuba (2003)',
      'Premio Nacional de Música — Cuba (2005)',
      'Honor al Mérito — México',
      'Distinción por la Cultura Nacional — Cuba',
      'Premio ACE — Asociación de Cronistas del Espectáculo de Nueva York (2015)',
    ],
  },
  {
    id: 'salvador-wood',
  ...
  },
  {
    ...
    name: 'Verónica Lynn',
    birthYear: 1931,
    birthPlace: 'San Diego de los Baños, Pinar del Río, Cuba',
    nationality: 'Cubana',
    photo: '/images/actors/veronica-lynn.jpg',
    biography: "Verónica Lynn López Martínez nació el 7 de mayo de 1931 en San Diego de los Baños, Pinar del Río. De familia muy humilde, creció en La Habana donde estudió con el reconocido director teatral Andrés Castro, formado en la escuela de Piscator en Nueva York. Debutó en televisión ganando un concurso en el Canal 4 de Gaspar Pumarejo y durante más de siete décadas se convirtió en una de las figuras más completas e influyentes de la cultura cubana, transitando con igual maestría por el teatro, la radio, la televisión y el cine. En el teatro su legado es inconmensurable: desde La gata en el tejado de zinc caliente hasta obras de Piñera, Carpentier y Shakespeare, siempre fiel al método Stanislavski que convirtió en su credo artístico. En 1989 cofundó con su esposo, el actor Pedro Álvarez, el grupo teatral Trotamundos, que dirigió tras el fallecimiento de Pedro en 1991. En el cine participó en más de 20 películas, con actuaciones memorables en Video de familia, La anunciación y 3 veces 2. Directora del grupo Trotamundos, profesora del ISA y del ICRT, y Hija Adoptiva de La Habana, Verónica Lynn es el paradigma de la artista cubana que entregó su vida entera al arte. En mayo de 2026 celebró sus 95 años con un homenaje televisivo nacional y el estreno de un documental sobre su trayectoria.",
    awards: [
      'Premio a la Mejor Actuación de Teatro — por La gata en el tejado de zinc caliente (1956)',
      'La Palma de Plata — Periódico Revolución, por Aire frío (1962)',
      'Premio de Actuación Femenina en Televisión — UNEAC (1982)',
      'Premio de Actuación Femenina en Televisión — UNEAC (1986)',
      'Premio de Actuación de Reparto — UNEAC, La Habana (1983)',
      'Premio de Actuación de Reparto — UNEAC, La Habana (1999)',
      'Premio Nacional de Teatro — Cuba (2003)',
      'Premio Nacional de Televisión — Cuba (2005)',
      'Premio Especial Honorífico de Actuación Enrique Almirante (2019)',
      'Nominación Premios Macondo — Mejor Actriz Principal, por Candelaria (2019)',
      'Distinción por la Cultura Nacional — Consejo de Estado de Cuba',
      'Medalla Alejo Carpentier — Cuba',
      'Premio Omar Valdés por la Obra de la Vida',
      'Premio Nicolás Guillén por la Obra de la Vida',
