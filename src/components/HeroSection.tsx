...
// CAMBIO ÚNICO: Usamos la URL directa en lugar del "import" local para evitar el error
const heroImage =
  'https://raw.githubusercontent.com/enriquebarroso/cinecuba-landing/main/src/assets/hero-memorias.jpg';
        ...
        <div className="container mx-auto px-6 lg:px-12">
          <div className="max-w-2xl space-y-6 animate-fade-in">
            ...
            <p className="text-lg text-muted-foreground font-light leading-relaxed max-w-lg">
              La obra maestra de Tomás Gutiérrez Alea. Un intelectual burgués
              observa la transformación de La Habana tras la Revolución,
